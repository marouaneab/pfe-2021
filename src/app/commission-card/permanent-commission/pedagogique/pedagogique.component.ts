...
@Component({
  ...
  templateUrl: './pedagogique.component.html',
  styleUrls: ['./pedagogique.component.scss']
})
export class PedagogiqueComponent extends CMSMembersComponent implements OnInit {
  ...
  ngOnInit() {
    this.service.getMembers('commission-pedagogique').subscribe(
      list => {
